...
class PromoDetailsAdapter extends TypeAdapter<PromoDetails> {
  @override
  final int typeId = 3;

  @override
  PromoDetails read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, PromoDetails obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.idPromo)
